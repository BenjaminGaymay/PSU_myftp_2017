...
#define REQUEST_PORT "425 PASV or PORT requested."
#define CONNECT_FAILED "425 Can't open data connection."
#define LOCAL_ERR "451 Requested action aborted: local error in processing."
#define BAD_CMD "500 Bad command."
#define BAD_LOG "530 Bad login."
#define NOT_CONNECTED "530 You are not connected."
#define FILE_NOT_EXIST "550 Failed to open file."
